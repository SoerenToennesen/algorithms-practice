#The solution below first finds all leaves that the frog can jump to within one jump, then for each of these sets this as index[0] and repeats.
#solution found online on stackoverflow...
def gen_fib(n):
    fn = [0,1]
    i = 2
    s = 2
