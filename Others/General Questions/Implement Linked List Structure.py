...
#here is a complex example of a multi level linked list.
#the idea is to flatten a multi level matrix structure
#we simply do this by iterating over the data, and if child, adding it to the end by setting it as the next of the last.
class Node:
